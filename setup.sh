...
# setup.sh — Bootstrap script for Area51
...
# Where verbose bootstrap logs go. area51.sh captures setup.sh's stdout to
...
# Default: write to the raw bootstrap log if area51.sh pointed us there,
# else fall back to a dedicated bootstrap log (keeps standalone `bash
# setup.sh` invocations working).
LOG_FILE="${AREA51_BOOTSTRAP_LOG:-${PROJECT_ROOT}/logs/bootstrap.log}"
