...
vi.mock('./config.js', async () => {
  ...
  return { ...actual, DATA_DIR: '/tmp/area51-test-host' };
});
...
const TEST_DIR = '/tmp/area51-test-host';
...
describe('session manager', () => {
  ...
  it('should refuse path-traversal in attachment filenames', () => {
    ...
    const escapeTarget = path.join('/tmp', 'area51-traversal-canary');
    ...
    writeSessionMessage('ag-1', session.id, {
      ...
      content: JSON.stringify({
        ...
        attachments: [
          {
            type: 'document',
            name: '../../../../../../../../tmp/area51-traversal-canary',
