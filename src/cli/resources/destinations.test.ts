/**
 * Regression test for #2465 — approval-path `area51 destinations add/remove`
...
vi.mock('../../config.js', async () => {
  ...
  return { ...actual, DATA_DIR: '/tmp/area51-test-cli-destinations' };
});

const TEST_DIR = '/tmp/area51-test-cli-destinations';
