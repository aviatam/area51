/**
 * Regression test for #2525 — `area51 groups delete` must cascade dependent
...
vi.mock('../../config.js', async () => {
  ...
  return { ...actual, DATA_DIR: '/tmp/area51-test-cli-groups' };
});

const TEST_DIR = '/tmp/area51-test-cli-groups';
